...
function flattenData(
  ...
  return items.map((item) => ({
    ...
    distributorTaxCode: item.distributor.taxCode,
    distributorEstablishment: item.distributor.establishment,
    distributorManager: item.distributor.manager,
    distributorActivated: item.distributor.activated,
    distributorDescription: item.distributor.description,
